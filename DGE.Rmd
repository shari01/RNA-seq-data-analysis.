...
#write_xlsx(normalized_counts, "enter the output location normalized.xlxs")

  write.csv(normalized_counts, "enter the output location ormalized.csv", row.names = FALSE)
...
write_csv(pca_data, "enter the output location of pca file" pca.csv")
```
...
write_csv(pca_top10, "enter the output location PCA_top10.csv")
